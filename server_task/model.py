...
class SentenceModel(BaseModel):
    sentCategory : int         # 문장 분류 결과
    sentCategoryScore : float  # 문장 분류 점수
    sentKeyword : str          # 문장 내 주요 키워드
    keywordScore : float       # 문장 내 주요 키워드의 점수
    sentence : str              # 키워드가 속한 주요 문장

class PhoneCallModel(BaseModel):
    totalCategory : int         # 통화 내용 분류 결과
    totalCategoryScore : float  # 통화 내용 분류 점수
    results : List[SentenceModel] | None = None